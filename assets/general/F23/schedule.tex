...
\wkday{6}{10/2}{10/6}    & 3.2 \par \due{HW 3.1} & 4.1 & \phantom{x} \par \due{HW 3.2 (Sat)} \\ \hline

\wkday{7}{10/9}{10/13}   & 4.3 \par \due{HW 4.1} & \ee{Quiz 3} \par 4.2 & 4.4 \par \due{HW 4.3 (Sat)} \\ \hline

\wkday{8}{10/16}{10/20}  &  & \ee{Midterm Exam} & 5.1 \\ \hline

\wkday{9}{10/23}{10/27}  & 5.3 (\& 4.10) & 6.1 & 6.2 \\ \hline
