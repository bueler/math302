...
\wkday{3}{9/11}{9/15}    & 2.2 \par \due{HW 1.3}  & \ee{Quiz 1} & 2.3 \par \due{HW 2.1 (Sat)}  \\ \hline

\wkday{4}{9/18}{9/22}    & 2.4 \par \due{HW 2.2} &  & 2.6 \par \due{HW 2.3 (Sat)} \\ \hline

\wkday{5}{9/25}{9/29}    & 3.1 \par \due{HW 2.4} & \ee{Quiz 2} & 3.2 \par \due{HW 2.6 (Sat)} \\ \hline
