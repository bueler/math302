...
\wkday{9}{10/23}{10/27}  & \phantom{x} \par \due{HW 4.4} & 5.1 & 5.3 (\& 4.10) \par \due{HW 5.1 part I (Sat)} \\ \hline

\wkday{10}{10/30}{11/3}  & \phantom{x} \par \due{HW 5.1 part II} & \ee{Quiz 4} \par 6.1 & \,\dl{withdraw} \par \due{HW 5.3 (Sat)}  \\ \hline

\wkday{11}{11/6}{11/10}  & 6.2 & 9.1 & 9.2 \\ \hline
