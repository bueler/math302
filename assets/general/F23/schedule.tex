...
\begin{document}
\hfill \small \emph{version 23: \today} \normalsize
...
\wkday{14}{11/27}{12/1}  & 7.3 \par \due{HW 7.2} &  & 3.3, 8.1 \par \due{HW 7.3 (Sat)} \\ \hline

\wkday{15}{12/4}{12/8}   & 8.2 \par \due{HW 3.3} & \ee{Quiz 6}\par 8.4 & 9.1, 9.2 \\ \hline
