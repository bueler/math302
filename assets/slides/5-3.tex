...
\begin{frame}[fragile]
\frametitle{\texttt{ode45} for pendulum: better and fancier}

\small
\begin{itemize}
\item the solution is more accurate than it looks!
\item for better look: ask \texttt{ode45} to generate more points (left fig.):
\begin{Verbatim}[fontsize=\small]
>> [tt,zz] = ode45(f,[0:.01:20],[3;0]);
\end{Verbatim}
\item one can even make a \href{https://bueler.github.io/math302/assets/codes/pendmovie.gif}{movie}
    \begin{itemize}
    \item see \href{https://bueler.github.io/math302/assets/codes/pendmovie.m}{\texttt{pendmovie.m}} (\href{https://bueler.github.io/math302/codes.html}{Codes} at \href{https://bueler.github.io/math302/}{\texttt{bueler.github.io/math302}})
